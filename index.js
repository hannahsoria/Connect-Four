document.addEventListener('DOMContentLoaded', () => 
{
    ...
    const winningArrays = [[0, 1, 2, 3],[41, 40, 39, 38],[7, 8, 9, 10],[34, 33, 32, 31],
        ...
        [6, 13, 20, 27],[35, 28, 21, 14],[0, 8, 16, 24],[41, 33, 25, 17],[7, 15, 23, 31],
        [34, 26, 18, 10],[14, 22, 30, 38],[27, 19, 11, 3],[35, 29, 23, 17],[6, 12, 18, 24],
        [28, 22, 16, 10],[13, 19, 25, 31],[21, 15, 9, 3],[20, 26, 32, 38],[36, 30, 24, 18],
        [5, 11, 17, 23],[37, 31, 25, 19],[4, 10, 16, 22],[2, 10, 18, 26],[39, 31, 23, 15],
        [1, 9, 17, 25],[40, 32, 24, 16],[9, 17, 25, 33],[8, 16, 24, 32],[11, 17, 23, 29],
    ...
    function checkBoard (){
        for (let y = 0; y < winningArrays.length; y++){
            ...
            // check those squares to see if they all have class p1
            if (
